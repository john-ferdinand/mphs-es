 ...
 * @author Acer
 */
public class Old_RegistrationForm extends javax.swing.JPanel {
    //HAS-A
    private final SchoolYearJCompModelLoader schoolYearCompModelLoader;
    private final GradeLevelJCompModelLoader gradeLevelCompModelLoader;
    private final GradeLevelDaoImpl gradeLevelDaoImpl;
    private final CredentialDaoImpl credentialDaoImpl;
    private final CredentialJCompModelLoader credentialGUIUtil;
    private final NavigationImpl navigation;
    
    public Old_RegistrationForm() {
        schoolYearCompModelLoader = new SchoolYearJCompModelLoader();
        gradeLevelCompModelLoader = new GradeLevelJCompModelLoader();
        gradeLevelDaoImpl = new GradeLevelDaoImpl();
        credentialDaoImpl = new CredentialDaoImpl();
        credentialGUIUtil = new CredentialJCompModelLoader();
        ...
        jcmbSchoolYearEnd.setModel(schoolYearCompModelLoader.getCurrentSchoolYearTo());
        jcmbSchoolYearEnd.setSelectedIndex(-1);
        
        PaymentTermDaoImpl ptdi = new PaymentTermDaoImpl();
        DefaultComboBoxModel paymentTermModel = new DefaultComboBoxModel(ptdi.getAll().toArray());
        
        jcmbDobMonth.setModel(CalendarJCompModelLoader.getMonthsOfYear());
        jcmbDobYear.setModel(CalendarJCompModelLoader.getNYearToNYears(1950, Calendar.getInstance().get(Calendar.YEAR)) );
...
//        registration.setBirthday(dob);
        ...
        registration.setRegion(jtfProvince.getText().trim());
        ...
        registration.setGradeLevelNo(gradeLevelNo);
