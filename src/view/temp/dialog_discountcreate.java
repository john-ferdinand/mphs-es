 ...
 */
public class dialog_discountcreate extends javax.swing.JDialog {

    /**
     * Creates new form dialog_discountcreate
     */
    public dialog_discountcreate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Create New Discount");
        setMinimumSize(new java.awt.Dimension(555, 380));
        setModal(true);
        setPreferredSize(new java.awt.Dimension(555, 380));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_discountcreate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_discountcreate dialog = new dialog_discountcreate(new javax.swing.JFrame(), true);
