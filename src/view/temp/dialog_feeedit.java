 ...
 */
public class dialog_feeedit extends javax.swing.JDialog {

    /**
     * Creates new form dialog_feeedit
     */
    public dialog_feeedit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panel_toppanel.setMinimumSize(new java.awt.Dimension(555, 530));
        panel_toppanel.setPreferredSize(new java.awt.Dimension(555, 530));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_feeedit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_feeedit dialog = new dialog_feeedit(new javax.swing.JFrame(), true);
