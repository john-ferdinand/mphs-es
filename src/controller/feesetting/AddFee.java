 ...
 * @author Jordan
 */
public class AddFee extends FormInspector implements ActionListener, FormValidator{

    private final JDialog jdlgFeeCrud;
    ...
    public AddFee(
            ...
            JTextArea jtaDescription, JPanel jpnlGradeLevel,JDialog jdlgFeeCrud
    ) {
        ...
        if (formIsValid()) {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                if (addFee()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Successfully added fee.");
                    jdlgFeeCrud.dispose();
                }
            }
        }
    ...
    private boolean addFee() {
        ...
        isAdded = feeDaoImpl.addFee(fee);
        return isAdded;
    }
    
    private boolean feeExists(){
        return feeDaoImpl.exists(jtfFeeName.getText().trim());
    }
