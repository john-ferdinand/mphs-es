 ...
 */
public class Edit_ItemListener_GradeLevel_JComboBox implements ItemListener {
    ...
    public Edit_ItemListener_GradeLevel_JComboBox(Dialog_EditSchedule view) {
        this.view = view;
        ...
        this.jcmbSchoolYear = view.getJcmbSchoolYearFrom();
