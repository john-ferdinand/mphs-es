 ...
 * @author Jordan
 */
public class Edit_KeyListener_ScheduleMasterList_SearchBox_JTextField implements KeyListener{
    
    private final Panel_ClassSchedules view;
    private final ScheduleJCompModelLoader scheduleJCompModelLoader;
    
    public Edit_KeyListener_ScheduleMasterList_SearchBox_JTextField(Panel_ClassSchedules view) {
        this.view = view;
